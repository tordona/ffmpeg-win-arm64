...
## Stable Releases
Stable releases are based on the last three major releases with minor and patch versions.

* [FFmpeg v9.0.2](https://github.com/tordona/ffmpeg-win-arm64/releases/tag/9.0.2)
* [FFmpeg v8.1.3](https://github.com/tordona/ffmpeg-win-arm64/releases/tag/8.1.3)
